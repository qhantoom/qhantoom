...
#[test]
fn tokenize_number_bins() {
  let file = read_file("../../samples/tests/tokens/bins.qh");
  let tokens = tokenize(&file);
...
#[test]
fn tokenize_number_octs() {
  let file = read_file("../../samples/tests/tokens/octs.qh");
  let tokens = tokenize(&file);
...
#[test]
fn tokenize_number_hexs() {
  let file = read_file("../../samples/tests/tokens/hexs.qh");
  let tokens = tokenize(&file);
